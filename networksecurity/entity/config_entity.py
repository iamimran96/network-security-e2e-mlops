...
class DataValidationConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.drift_report_file_path: str = os.path.join(
            self.data_validation_dir,
            traning_pipeline.DATA_VALIDATON_DRIFT_REPORT_DIR,
            traning_pipeline.DATA_VALIDATON_DRIFT_REPORT_FILE_NAME
        )
...
class ModelTrainerConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.expected_accuracy: float = traning_pipeline.MODEL_TRAINER_EXPECTED_ACCURACY
        self.overfitting_underfiitting_threshold: float = traning_pipeline.MODEL_TRAINER_OVERFITTING_UNDERFITTING_THRESHOLD